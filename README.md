...
```
sbt assembly
java -jar avro-tools/target/scala-2.11/avro-tools-1.9.0.jar tojson <GCS_PATH>
java -jar parquet-tools/target/scala-2.11/parquet-tools-1.10.1.jar cat <GCS_PATH>
