...
```
sbt assembly
java -jar avro-tools/target/scala-2.13/avro-tools-1.8.2.jar tojson <GCS_PATH>
java -jar parquet-tools/target/scala-2.13/parquet-tools-1.11.0.jar cat <GCS_PATH>
java -jar proto-tools/target/scala-2.13/proto-tools-3.12.2.jar cat <GCS_PATH>
```
